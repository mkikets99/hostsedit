...
!macro CustomCodePostInstall
	Rename "$INSTDIR\jre1.8.0_231\bin" "$INSTDIR\bin"
	Rename "$INSTDIR\jre1.8.0_231\lib" "$INSTDIR\lib"
	Rename "$INSTDIR\jre1.8.0_231\COPYRIGHT" "$INSTDIR\COPYRIGHT"
	Rename "$INSTDIR\jre1.8.0_231\LICENSE" "$INSTDIR\LICENSE"
	Rename "$INSTDIR\jre1.8.0_231\README.txt" "$INSTDIR\README.txt"
	Rename "$INSTDIR\jre1.8.0_231\release" "$INSTDIR\release"
	Rename "$INSTDIR\jre1.8.0_231\THIRDPARTYLICENSEREADME.txt" "$INSTDIR\THIRDPARTYLICENSEREADME.txt"
	Rename "$INSTDIR\jre1.8.0_231\THIRDPARTYLICENSEREADME-JAVAFX.txt" "$INSTDIR\THIRDPARTYLICENSEREADME-JAVAFX.txt"
	Rename "$INSTDIR\jre1.8.0_231\Welcome.html" "$INSTDIR\Welcome.html"
	RMDir "$INSTDIR\jre1.8.0_231"
